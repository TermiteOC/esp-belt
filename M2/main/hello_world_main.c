...
#define WIFI_SSID "AndroidAPEE80"
#define WIFI_PASS "qlma2773"
...
// Número sequencia de relatórios
...
static void task_sort_act(void *arg)
{
    ...
    for (;;) {
        if (xQueueReceive(qSort, &ev, portMAX_DELAY) == pdTRUE) {
            ...
            // Atualiza (m,k)-firm: "deadline cumprida" se latency_us < deadline_us
            const int64_t deadline_us = 20000; // 20ms deadline
